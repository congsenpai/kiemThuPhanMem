...
WebUI.setText(findTestObject('Admin/Customer/input_find'), 'vanson21102003@gmail.com')

WebUI.click(findTestObject('Admin/Customer/Button_find'))

WebUI.verifyElementText(findTestObject('Admin/Customer/Check_find'), 'vanson21102003@gmail.com')
