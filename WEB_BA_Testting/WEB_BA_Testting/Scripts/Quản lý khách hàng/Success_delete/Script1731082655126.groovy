...
WebUI.click(findTestObject('Admin/Customer/Button_delete'))
...
WebUI.verifyElementText(findTestObject('Admin/General/Check_alert_general_toprightScreen'), 'Xóa khách hàng thành công.')
