...
WebUI.verifyElementText(findTestObject('Admin/PassWord/p_Vui lng nhp mt khu c'), 'Vui lòng nhập mật khẩu cũ.')

WebUI.verifyElementText(findTestObject('Admin/PassWord/p_Vui lng nhp mt khu mi'), 'Vui lòng nhập mật khẩu mới.')
