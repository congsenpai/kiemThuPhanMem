...
WebUI.click(findTestObject('Admin/Staff/Button_delete'))

if (WebUI.waitForAlert(5)) {
    WebUI.comment('Have a alert and success')

    WebUI.dismissAlert( // Đóng alert nếu có
        )
} else {
...
WebUI.verifyElementText(findTestObject('Admin/General/Check_alert_general_toprightScreen'), 'Xóa nhân viên thành công.')
