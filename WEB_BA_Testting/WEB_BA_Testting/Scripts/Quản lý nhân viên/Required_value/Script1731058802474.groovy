...
WebUI.verifyElementText(findTestObject('Admin/Staff/p_The email field is required'), 'The email field is required.')

WebUI.verifyElementText(findTestObject('Admin/Staff/p_The name field is required'), 'The name field is required.')

WebUI.verifyElementText(findTestObject('Admin/Staff/p_The name field is required'), 'The name field is required.')

WebUI.verifyElementText(findTestObject('Admin/Staff/p_The password confirmation field is required'), 
    'The password confirmation field is required.')

WebUI.verifyElementText(findTestObject('Admin/Staff/p_The password field is required'), 'The password field is required.')
