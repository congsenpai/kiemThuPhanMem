...
WebUI.setText(findTestObject('Admin/General/input_find'), 'Sầu Riêng')

WebUI.click(findTestObject('Admin/General/button_find'))

WebUI.verifyElementText(findTestObject('Admin/Category/Chức Năng Tìm Kiếm/Check_Tìm kiếm'), 'Sầu Riêng')
