...
WebUI.click(findTestObject('Admin/Controller/Button_Order'))

WebUI.selectOptionByIndex(findTestObject('Admin/Controller/select_OrderState'), 1)

String check = WebUI.getText(findTestObject('Admin/Controller/span_check_selected'))
