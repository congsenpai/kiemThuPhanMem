...
WebUI.click(findTestObject('Admin/Product/button_update_out'))

WebUI.setText(findTestObject('Admin/Product/input_create_name'), 'TH Truemilk update')
...
WebUI.setText(findTestObject('Admin/Product/describe_text'), 'update test')
...
WebUI.verifyElementText(findTestObject('Admin/Product/Check_success'), 'Cập nhật sản phẩm thành công.')
