...
WebUI.setEncryptedText(findTestObject('Admin/PassWord/input_old_password'), 'aeHFOx8jV/A=')

WebUI.setEncryptedText(findTestObject('Admin/PassWord/input_new_password'), 'RigbBhfdqODKcAsiUrg+1Q==')

WebUI.setEncryptedText(findTestObject('Admin/PassWord/input_new_password_confirmation'), 'ZruJp98OYgtlfaoOWMeWVw==')

WebUI.click(findTestObject('Admin/PassWord/button_Save'))

WebUI.verifyElementText(findTestObject('Admin/PassWord/p_Mt khu nhp li khng khp'), 'Mật khẩu nhập lại không khớp.')
