...
WebUI.setText(findTestObject('Page_Biolife - Organic Food/input_email_login'), '')
...
WebUI.verifyElementText(findTestObject('Page_Biolife - Organic Food/Required_email_alert'), 'The email field is required.')
