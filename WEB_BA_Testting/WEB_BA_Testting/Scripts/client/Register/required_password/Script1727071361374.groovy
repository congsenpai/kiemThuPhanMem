...
WebUI.setEncryptedText(findTestObject('Register/input_password_register'), '')
...
WebUI.verifyElementText(findTestObject('Register/Required_pass_register_alert'), 'Mật khẩu không được để trống.')
