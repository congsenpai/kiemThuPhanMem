...
WebUI.setText(findTestObject('Register/input_email_register'), '')
...
WebUI.verifyElementText(findTestObject('Register/Required_email_register_alert'), 'Địa chỉ email không được để trống.')
