...
WebUI.setText(findTestObject('Register/input_email_register'), 'laptrinhmobilecntc')
...
WebUI.verifyElementText(findTestObject('Register/Error_not_match_pass_with_comfime_register_alert'), 'The email field must be a valid email address.')
