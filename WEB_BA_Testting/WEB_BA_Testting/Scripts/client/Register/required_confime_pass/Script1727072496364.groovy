...
WebUI.setEncryptedText(findTestObject('Register/input_confim_password_register'), '')

WebUI.click(findTestObject('Register/Button_register'))

WebUI.verifyElementText(findTestObject('Register/Required_confime_password_alert'), 'Mật khẩu không được để trống.')
