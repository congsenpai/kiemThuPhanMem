...
WebUI.setText(findTestObject('Register/input_name_register'), '')
...
WebUI.verifyElementText(findTestObject('Register/Require_name_register_alert'), 'Họ tên không được để trống.')
